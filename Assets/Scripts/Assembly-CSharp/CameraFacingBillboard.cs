	...
	private void LateUpdate()
	{
		...
		if (mode != CameraFacingBillboard.BillboardMode.LookAt)
		{
			if (mode == CameraFacingBillboard.BillboardMode.Rotation)
			{
				...
				global::UnityEngine.Vector3 vector2 = rotation * global::UnityEngine.Vector3.forward;
				...
				global::UnityEngine.Vector3 worldUp = rotation2 * global::UnityEngine.Vector3.up;
		...
		else
		{
			...
			transform5.LookAt(position2, global::UnityEngine.Vector3.up);
