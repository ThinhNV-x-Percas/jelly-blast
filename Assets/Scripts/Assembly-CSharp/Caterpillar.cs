...
public class Caterpillar : RotatingSpecialFluid
{
	...
	public override void OnPreComputeUpdate()
	{
		...
		transform.position = new global::UnityEngine.Vector3(pos.x, pos.y, id * depthStride - 6f);
		...
		global::UnityEngine.Object.Instantiate(dust, transform.position + global::UnityEngine.Vector3.back * 3f, global::UnityEngine.Quaternion.identity);
