...
public class CaterpillarSpawner : global::UnityEngine.MonoBehaviour
{
	...
	public void OnInit()
	{
		...
		if (particleCount >= 1)
		{
			if (array == null)
			{
				...
				bool flag2 = !flag;
				CaterpillarSpawner caterpillarSpawner = this;
				if (!flag2)
				{
				...
				float num2 = insideUnitCircle.x * caterpillarSpawner.spawnRadius;
				float num3 = insideUnitCircle.y * caterpillarSpawner.spawnRadius;
		...
		Caterpillar caterpillar = Singleton<FluidSolver>.Instance.AddCaterpillar(array);
	}

	[global::Cpp2ILInjected.Token(Token = "0x6000186")]
	[global::Cpp2ILInjected.Address(RVA = "0xFE9CE8", Offset = "0xFE9CE8", Length = "0x14")]
	[global::AssetRipperInjected.NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tthis.particleCount = 0x4040000000000007;\n\tUnityEngine.MonoBehaviour::.ctor(this);\n\treturn;\n// 3 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
	public CaterpillarSpawner()
	{
