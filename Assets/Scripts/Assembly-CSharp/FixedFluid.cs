...
public class FixedFluid : global::UnityEngine.MonoBehaviour
{
	...
	private void Awake()
	{
		...
		nint num4 = 0;
		obj = (nint)obj8 + 144;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v183 @ X24_v8 (Il2CppMethodInfo)+538]");
	...
	public void OnInit()
	{
		...
		_ = 0;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Method not found @F3F1B4");
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v66 @ X0_v3 (System.Object)+10]");
		object obj4 = 0;
		float num3 = height * width;
		float num4 = num3;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v203 @ X8_v6+54]");
		float num5 = num4 * 0f;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v203 @ X8_v6+50]");
		float num6 = 0f * 0.25f;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v203 @ X8_v6+70]");
		int num7 = (int)((nint)0 & (nint)int.MaxValue);
		bool flag = num7 < 2139095040;
		bool flag2 = !flag;
		int num8 = num7 - 2139095040;
		bool flag3 = num8 == 0;
		bool flag4 = !flag2;
		bool flag5;
		if (flag4 || flag3)
		...
		float num14 = global::UnityEngine.Mathf.Ceil(num13);
		float num15 = num13 - float.Epsilon;
		bool flag6 = num15 < 0f;
		bool flag7 = num15 == 0f;
		object obj5 = num13 ^ 1;
		object obj6 = num13 ^ num15;
		int num16 = (int)((nint)obj5 & (nint)obj6);
		bool flag8 = num16 < 0;
		bool flag9 = flag6 == flag8;
		bool flag10 = !flag7;
		float num17 = ((!(flag9 && flag10)) ? float.Epsilon : num13);
		float num18 = num14 - float.PositiveInfinity;
		float num19 = ((num18 == 0f) ? float.Epsilon : num17);
		...
		if (array != null)
		{
			object obj7 = (nint)array + 36;
			int num20 = 0;
			do
			{
				float minInclusive = width * -0.5f;
				float maxInclusive = width * 0.5f;
				float num21 = global::UnityEngine.Random.Range(minInclusive, maxInclusive);
				float minInclusive2 = height * -0.5f;
				float maxInclusive2 = height * 0.5f;
				float num22 = global::UnityEngine.Random.Range(minInclusive2, maxInclusive2);
				float num23 = position2.y + num22;
				float num24 = position.x + num21;
				obj7 = num23;
				num20++;
				obj7 = (nint)obj7 + 8;
			}
			while (num19 != (float)num20);
			FixedFluid.SpecialFluidType specialFluidType = type;
			bool flag11 = type < FixedFluid.SpecialFluidType.Snow;
			bool flag12 = !flag11;
			int num25 = (int)(type - 3);
			bool flag13 = num25 == 0;
			bool flag14 = !flag13;
			if (!(flag12 && flag14))
			{
				int num26 = 42422272 + 2560;
				global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v311 @ X9_v6 (System.Int32)+v328 @ X8_v20 (FixedFluid+SpecialFluidType)]");
				int num27 = (int)((nint)0 << 2);
				int num28 = 16746872 + num27;
				global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Indirect jump: v280 @ X10_v2 (System.Int32) (should have been resolved before IL gen)");
			}
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Method not found @18AB640 (Singleton`1::get_Instance, and 1 more at this address)");
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v190 @ X0_v35+30]");
			Mud mud = ((FluidSolver)0).AddMud(array);
			return;
		}
		float minInclusive3 = width * -0.5f;
		float maxInclusive3 = width * 0.5f;
		float num29 = global::UnityEngine.Random.Range(minInclusive3, maxInclusive3);
		float minInclusive4 = height * -0.5f;
		float maxInclusive4 = height * 0.5f;
		float num30 = global::UnityEngine.Random.Range(minInclusive4, maxInclusive4);
		throw new global::System.NullReferenceException();
	}
