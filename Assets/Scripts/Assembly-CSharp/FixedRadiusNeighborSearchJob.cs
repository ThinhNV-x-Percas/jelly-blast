...
public struct FixedRadiusNeighborSearchJob : global::Unity.Jobs.IJobParallelFor
{
	...
	{
		global::Unity.Mathematics.float2 position = positions[index];
		int gridX = (int)global::UnityEngine.Mathf.Floor(position.x / cellSize);
		int gridY = (int)global::UnityEngine.Mathf.Floor(position.y / cellSize);
		int hash = gridY * 0x3DCF + gridX * 0x949475;
		int key = hash % capacity;
