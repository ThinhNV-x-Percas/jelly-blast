...
public class GameManager : Singleton<GameManager>
{
	...
	private void Update()
	{
		...
		value.z = forward.z;
		value.w = 0f;
		global::UnityEngine.Shader.SetGlobalVector("_LightDirection", value);
		Level level = this.level;
		...
		if (!(time2 > particleQueueData.time))
		{
			return;
		}
		...
		int particlesSpawnedSinceLastFish = _particlesSpawnedSinceLastFish + particleQueueData2.count;
	...
	public void Reset()
	{
		...
		ApplicationManager applicationManager = global::Singleton<ApplicationManager>.Instance;
	...
	private bool ShouldSpawnFish()
	{
		...
		GoalData goalData = level.goals.Find((GoalData g) => g.goalType == GoalType.Fish);
		if (goalData == null)
		{
			return false;
		}
	...
	public GameManager()
	{
		...
		coinsCollected = 100;
		waters = new global::System.Collections.Generic.List<Water>();
		failTimerDuration = 3f;
		particleQueue = new global::System.Collections.Generic.List<ParticleQueueData>();
	}
}
