...
internal struct OctopusBodyCohesionJob : global::Unity.Jobs.IJobParallelFor
{
	...
	public unsafe void Execute(int index)
	{
		...
		if ((nint)0 == 0)
		{
			...
			{
				float num = float5.x;
				global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v113 @ X8_v9 (Unity.Collections.NativeArray`1<Unity.Mathematics.float2>)+index @ X1 (System.Int32)*8]");
				num2 = num - 0f;
			}
			else
			{
			...
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v103 @ X8_v17 (Unity.Collections.NativeArray`1<Unity.Mathematics.float2>)+v81 @ X9_v1 (System.Int32)]");
			float num9 = 0f + num8;
		}
	}
}
