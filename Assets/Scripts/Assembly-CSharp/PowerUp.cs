...
public class PowerUp : SpecialFluid
{
	...
	public override void OnPreComputeUpdate()
	{
		...
		transform.position = new global::UnityEngine.Vector3(pos.x, pos.y, id * depthStride - 5f);
	}
	...
	{
		UpdateArrowPostion(upArrow, global::UnityEngine.Vector2.up * arrowSpacing);
		UpdateArrowPostion(downArrow, global::UnityEngine.Vector2.down * arrowSpacing);
		UpdateArrowPostion(leftArrow, global::UnityEngine.Vector2.left * arrowSpacing);
		UpdateArrowPostion(rightArrow, global::UnityEngine.Vector2.right * arrowSpacing);
		...
		void UpdateArrowPostion(global::UnityEngine.Transform arrow, global::UnityEngine.Vector2 localPos)
		{
			global::UnityEngine.Transform mrTransform = mr.transform;
			arrow.position = mrTransform.position + global::UnityEngine.Vector3.Scale(localPos, mrTransform.localScale) + global::UnityEngine.Vector3.forward;
		}
	}
