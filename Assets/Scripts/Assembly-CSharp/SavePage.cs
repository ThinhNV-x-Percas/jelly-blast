...
public class SavePage : global::UnityEngine.MonoBehaviour
{
	...
	private void Awake()
	{
		...
		PLAYER_PREFS_PATH = string.Format("/data/data/{0}/shared_prefs/{0}.v2.playerprefs.xml", global::UnityEngine.Application.identifier);
		SAVE_FILE_PATH = global::UnityEngine.Application.persistentDataPath + "/savefile.txt";
		_logScroller = base.transform.root.GetComponent<UIState>().logScroller;
	}
	...
	{
		_logScroller.Log("muted: " + global::UnityEngine.PlayerPrefs.GetInt("muted"));
	}
	...
	{
		global::System.IO.Directory.Delete(LOGS_FOLDER_PATH, true);
	...
	public void OnSaveLogsBtnClick()
	{
		try
		{
			...
			string path = string.Format("{0}/{1}.txt", LOGS_FOLDER_PATH, global::System.DateTimeOffset.Now.ToUnixTimeSeconds());
			global::System.IO.File.WriteAllLines(path, _logScroller.texts);
	...
	public void OnLogSaveFileBtnClick()
	{
		try
		{
			...
			string[] lines = global::System.IO.File.ReadAllLines(SAVE_FILE_PATH);
