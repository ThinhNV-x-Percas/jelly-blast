...
public class SavePage : global::UnityEngine.MonoBehaviour
{
	...
	public void OnLogPlayerPrefsBtnClick()
	{
		...
		string text = "l1";
		string text2 = "l1";
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v18 @ X22_v1 (System.String)+8E8]");
		string text3 = (string)0;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v18 @ X22_v1 (System.String)+8E8]");
		text3 = global::UnityEngine.PlayerPrefs.GetInt((string)0).ToString();
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v20 @ X20_v1 (System.String)+8F0]");
		text3 = (string)0;
		text3 += text3;
	...
	public void OnSavePlayerPrefsBtnClick()
	{
		...
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v18 @ X21_v1 (System.String)+1E0]");
		string text2 = (string)0 + PLAYER_PREFS_PATH;
	...
	public void OnDeleteLogFilesBtnClick()
	{
		...
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v43 @ X8_v3 (System.String)+C20]");
	...
	public void OnSaveLogsBtnClick()
	{
		...
		if ((object)_logScroller != null)
		{
			string text = "Parent table name is missing in relation '{0}'.";
			LogScroller logScroller = _logScroller;
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v52 @ X8_v5 (System.String)+F88]");
			logScroller.Log((string)0);
			...
			SavePage savePage = (SavePage)0;
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unknown call target operand: \"il2cpp_vm_object_box\"");
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v86 @ X21_v2 (System.String)+618]");
			object obj = default(object);
			string text3 = string.Format((string)0, LOGS_FOLDER_PATH, obj);
			LogScroller logScroller2 = _logScroller;
			if ((object)_logScroller != null)
			{
				global::System.IO.File.AppendAllLines(text3, logScroller2.texts);
				string text4 = "IsCyrillic";
				global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v170 @ X8_v9 (System.String)+A88]");
				string text5 = (string)0 + text3;
				if ((object)_logScroller != null)
				{
					_logScroller.Log(text5);
					return;
				}
	...
	public void OnAppendSaveFileBtnClick()
	{
		...
		{
			string text = "<'width'>";
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v44 @ X8_v5 (System.String)+EE0]");
			string text2 = (string)0;
			LogScroller logScroller = _logScroller;
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v44 @ X8_v5 (System.String)+EE0]");
			logScroller.Log((string)0);
			global::UnityEngine.UI.InputField customInputField = _customInputField;
			if ((object)_customInputField != null)
			{
				nint num = 0;
				string text3 = customInputField.text;
				global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v57 @ X9_v2 (Il2CppFieldInfo)+AB0]");
				string text4 = text3 + (string)0;
				global::System.IO.File.AppendAllText(SAVE_FILE_PATH, text4);
				if ((object)_customInputField != null)
				{
					nint num2 = 0;
					global::UnityEngine.UI.InputField customInputField2 = _customInputField;
					global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v94 @ X8_v8 (Il2CppFieldInfo)+960]");
					customInputField2.text = (string)0;
					string text5 = "<'width'>";
					global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v99 @ X8_v10 (System.String)+ED8]");
					string text6 = (string)0 + SAVE_FILE_PATH;
					if ((object)_logScroller != null)
					{
						_logScroller.Log(text6);
						return;
					}
					global::System.NullReferenceException ex = new global::System.NullReferenceException();
					object obj = 0;
	...
	public void OnDeleteSaveFileBtnClick()
	{
		...
		string text = "Parent table name is missing in relation '{0}'.";
		LogScroller logScroller = _logScroller;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v42 @ X8_v3 (System.String)+F60]");
		logScroller.Log((string)0);
	}
	...
	public void OnLogSaveFileBtnClick()
	{
		...
		if ((object)_logScroller != null)
		{
			...
			LogScroller logScroller = _logScroller;
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v48 @ X8_v5 (System.String)+9C8]");
			logScroller.Log((string)0);
			...
			if (array != null)
			{
				...
				global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unknown call target operand: \"il2cpp_vm_object_box\"");
				nint num2 = 0;
				global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v100 @ X8_v9 (Il2CppFieldInfo)+AB0]");
				string arg = string.Join((string)0, array);
				string text2 = "Parent table name is missing in relation '{0}'.";
				global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v108 @ X8_v11 (System.String)+F68]");
				object arg2 = default(object);
				string text3 = string.Format((string)0, arg2, arg);
				if ((object)_logScroller != null)
				{
					_logScroller.Log(text3);
					return;
	...
	public void OnLogSaveFilePathBtnClick()
	{
		//IL_0035: Expected O, but got I
		string text = "Parent table name is missing in relation '{0}'.";
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v18 @ X21_v1 (System.String)+F70]");
		string text2 = (string)0 + SAVE_FILE_PATH;
		_logScroller.Log(text2);
	}
