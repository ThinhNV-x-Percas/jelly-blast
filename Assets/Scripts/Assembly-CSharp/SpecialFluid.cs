...
public class SpecialFluid : FluidRendererBase
{
	...
	public unsafe virtual void Init(FluidSolver _solver, global::System.Collections.Generic.HashSet<int> _particleIds, int _fluidType, FluidCompute _compute)
	{
		...
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v80 @ X0_v7+38]");
		object obj3 = 0;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v88 @ X8_v7+28]");
		fixedDeltaTime = 0f;
		...
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v335 @ X8_v8 (System.String)+9E0]");
		...
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v336 @ X8_v10 (System.String)+970]");
		...
		if ((object)obj9 != null)
		{
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v337 @ X24_v8 (Il2CppClass<System.Collections.Generic.NullableComparer`1>)+DB8]");
			int num7 = 0;
			...
			bool flag3 = num7 != 1;
			int num10 = num7;
			global::System.InvalidCastException ex2 = ex;
			if (!flag3)
			{
				...
				object obj13 = obj12;
				ex2 = (global::System.InvalidCastException)(object)ex3;
			}
	...
	public virtual void AddParticles(global::Unity.Mathematics.float2[] positionsToAdd)
	{
		...
		global::System.Action<ParticleInitData> action = null;
		int num = default(int);
		object obj2 = num;
		int num2 = 50503680;
		...
		if (!flag)
		{
			global::System.Collections.Generic.HashSet<int> hashSet = solver.AddParticles(array, fluidType);
			bool flag2 = hashSet == null;
			int num3 = 0;
			action = null;
			global::Unity.Mathematics.float2[] array2 = default(global::Unity.Mathematics.float2[]);
			array = array2;
		...
		bool flag4 = (nint)array != 1;
		global::System.NullReferenceException ex2 = ex;
		if (!flag4)
		{
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Method not found @274A080 (inside System.__Il2CppComDelegate::Finalize +0xF54)");
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Method not found @274A098 (inside System.__Il2CppComDelegate::Finalize +0xF6C)");
			array = (global::Unity.Mathematics.float2[])num2;
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Method not found @14993C4 (System.Collections.Generic.HashSet`1+Enumerator::Dispose, and 1 more at this address)");
	...
	public void AddSolverParticle(int id)
	{
		...
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v222 @ X24_v3 (Il2CppMethodInfo)+FB0]");
		global::System.Action<ParticleInitData> action = new global::System.Action<ParticleInitData>(obj, (global::System.IntPtr)0);
		compute.InitParticle(num4, fluidCompute.activeCount);
		if (action != null)
		{
			ParticleInitData particleInitData = new ParticleInitData(fluidCompute.activeCount, num4, 0);
			global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Indirect call: v128.invoke_impl (System.IntPtr) (should have been resolved before IL gen)");
		}
		int num8 = fluidCompute.activeCount + 1;
		fluidCompute.activeCount = num8;
	...
	public override void OnPreComputeUpdate()
	{
		...
		//IL_04bb: Expected F4, but got O
		//IL_04d0: Expected F4, but got I
		//IL_04e5: Expected F4, but got I
		//IL_04fa: Expected F4, but got I
		...
		if (activeCount >= 1)
		{
			...
			do
			{
				...
				if (obj4 != null)
				{
					...
					int num8 = (int)((nint)obj5 << 3);
					object obj6 = fluidSolver2.positions + num8;
					float5.x = (float)obj6;
					global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v447 @ X8_v18+4]");
					float5.y = 0f;
					global::UnityEngine.Vector2 vector = float5;
					object obj7 = (nint)positions + num7;
					_ = vector.y;
					FluidSolver fluidSolver3 = solver;
					int num9 = (int)((nint)obj5 << 3);
					object obj8 = fluidSolver3.positionsPrev + num9;
					float6.x = (float)obj8;
					global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v700 @ X8_v23+4]");
					float6.y = 0f;
					global::UnityEngine.Vector2 vector2 = float6;
					int num10 = num6 << 3;
					object obj9 = (nint)positions + num10;
					global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v707 @ X8_v25+20]");
					float num11 = 0f - vector2.x;
					float num12 = num11 * (float)obj10;
					float num13 = vector2.x + num12;
					int num14 = num6 << 3;
					object obj11 = (nint)interpPositions + num14;
					FluidSolver fluidSolver4 = solver;
					float[] array2 = scales;
					global::Unity.Collections.NativeArray<float> nativeArray = fluidSolver4.scales;
					float num15 = particleSize;
					global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v395 @ X9_v14 (Unity.Collections.NativeArray`1<System.Single>)+v189 @ stack_-94_v5*4]");
					float num16 = num15 * 0f;
					array2[num6] = num16;
					int[] array3 = computeIds;
					FluidCompute fluidCompute = compute;
					if (fluidCompute.idToIndex.TryGetValue(array3[num6], out var value))
					{
						FluidCompute fluidCompute2 = compute;
						int num17 = num6 << 3;
						object obj12 = (nint)interpPositions + num17;
						int num18 = value << 3;
						object obj13 = (nint)fluidCompute2.positions + num18;
						global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v719 @ X9_v18+20]");
						_ = 0;
						float[] array4 = scales;
						float[] array5 = fluidCompute2.scales;
						array5[value] = array4[num6];
						FluidSolver fluidSolver5 = solver;
						global::UnityEngine.Vector4[] emissionColors = fluidCompute2.emissionColors;
						int num19 = (int)((nint)obj5 << 4);
						object obj14 = fluidSolver5.emissionColors + num19;
						float7.x = (float)obj14;
						global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v454 @ X8_v33+4]");
						float7.y = 0f;
						global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v454 @ X8_v33+8]");
						float7.z = 0f;
						global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v454 @ X8_v33+C]");
						float7.w = 0f;
						global::UnityEngine.Vector4 vector3 = float7;
						if (value >= emissionColors.Length)
						{
							throw new global::System.IndexOutOfRangeException();
						}
						int num20 = value << 4;
						object obj15 = (nint)emissionColors + num20;
						emissionColors[value].y = vector3.y;
						emissionColors[value].z = vector3.z;
						emissionColors[value].w = vector3.w;
					}
				}
				num6++;
				num7 += 8;
		...
		vector4.z = 0f;
		global::UnityEngine.Vector3 vector5 = main.WorldToViewportPoint(vector4);
		...
		vector6.y = min.y;
		vector6.z = 0f;
		global::UnityEngine.Vector3 vector7 = main2.WorldToViewportPoint(vector6);
		global::UnityEngine.Camera main3 = global::UnityEngine.Camera.main;
		global::UnityEngine.Vector3 vector8 = default(global::UnityEngine.Vector3);
		vector8.x = max.x;
		vector8.y = max.y;
		vector8.z = 0f;
		global::UnityEngine.Vector3 vector9 = main3.WorldToViewportPoint(vector8);
		mr.GetPropertyBlock(_propBlock);
		string text = "Writing object reference to Id '{0}' for {1}.";
		...
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v697 @ X8_v6 (System.String)+8B8]");
		propBlock.SetVector((string)0, value2);
		string text2 = "Writing object reference to Id '{0}' for {1}.";
		...
		value3.w = 0f;
		global::UnityEngine.MaterialPropertyBlock propBlock2 = _propBlock;
		global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v703 @ X8_v8 (System.String)+8B0]");
		...
		if (!flag)
		{
			...
			while (true)
			{
				...
				if ((int)((nint)obj2 & 1) != 0)
				{
					...
					bool flag2 = num5 == 0;
					obj5 = obj6;
					global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v65 @ X22_v4 (Il2CppMethodInfo)+C28]");
					obj7 = 0;
					if (!flag2)
					{
						FluidSolver fluidSolver = solver;
						global::Unity.Collections.NativeArray<float> nativeArray = fluidSolver.scales;
						obj5 = obj6;
						global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v65 @ X22_v4 (Il2CppMethodInfo)+C28]");
						obj7 = 0;
					}
		...
		if (!flag)
		{
			...
			while (true)
			{
				...
				if ((int)((nint)obj2 & 1) != 0)
				{
					...
					bool flag2 = num5 == 0;
					obj5 = obj6;
					global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v60 @ X22_v4 (Il2CppMethodInfo)+C28]");
					obj7 = 0;
					if (!flag2)
					{
						FluidSolver fluidSolver = solver;
						global::Unity.Collections.NativeArray<global::Unity.Mathematics.float4> emissionColors = fluidSolver.emissionColors;
						global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [2875980]");
						_ = 0;
						obj5 = obj6;
						global::Cpp2ILInjected.Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v60 @ X22_v4 (Il2CppMethodInfo)+C28]");
						obj7 = 0;
