...
public class Stone : Block
{
	...
	protected override void CheckClear(global::System.Collections.Generic.HashSet<int> particleIds, bool explode)
	{
		if (wasTouch)
		{
			return;
	...
	public override void OnClear()
	{
		...
		Singleton<CollectionManager>.Instance.OnCollectStoneBlock(pos, velocity);
	}
