	...
	public void OnPointerUp(global::UnityEngine.EventSystems.PointerEventData eventData)
{
		...
		// Fixed: the decompiled body resolved the manager to default(GameManager) (null)
		// and threw NullReferenceException on every tap. Native code called
		// Singleton<GameManager>.Instance.OnClickUserInputPanel(pos).
		Singleton<GameManager>.Instance.OnClickUserInputPanel(mousePos);
	}
